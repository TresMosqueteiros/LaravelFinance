...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="breadcrumb-holder">
                <h1 class="main-title float-left">Principal</h1>
    ...
    <div class="row">
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box noradius noborder bg-default">
                ...
                <h6 class="text-white text-uppercase m-b-20">Ordens</h6>
                <h1 class="m-b-20 text-white counter">1,587</h1>
                <span class="text-white">15 Novas Ordens</span>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box noradius noborder bg-warning">
                ...
                <span class="text-white">Rejeição: 25%</span>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box noradius noborder bg-info">
                ...
                <span class="text-white">25 Novos Usuários</span>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card-box noradius noborder bg-danger">
                ...
                <h6 class="text-white text-uppercase m-b-20">Alertas</h6>
                <h1 class="m-b-20 text-white counter">58</h1>
                <span class="text-white">5 Novos Alertas</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card mb-3">
                <div class="card-header">
                    <h3><i class="fa fa-bar-chart-o"></i> Entradas/Saídas</h3>
                    Acompanhe suas entradas e as suas saídas deste mês. Sua última alteração foi em 12/10/2018 às 22:90
                </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card mb-3">
                <div class="card-header">
                    <h3><i class="fa fa-envelope-o"></i> Últimos eventos</h3>
                    Aqui estão as suas últimas alterações
                </div>

                <div class="card-body">
                    <div class="widget-messages nicescroll" style="height: 250px;">
                        <a href="#">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <div class="card mb-3">
                <div class="card-header">
                    <h3><i class="fa fa-line-chart"></i> Resumo</h3>
                    Resumo de todos os dados de meses anteriores, assim você pode visualizar melhor como tem se saído na sua vida financeira.
                </div>
